...
DATA = np.genfromtxt('buoyancy_binary_interactions_Townsend_v2.txt',dtype='str')
...
plt.tight_layout()
np.savez('Townsend_buoyancy_binary_velocity_v2_'+str(timestamp), V_x_mono_0,V_x_0,V_x_mono_2, V_x_2, V_x_mono_5, V_x_5, lamda)
